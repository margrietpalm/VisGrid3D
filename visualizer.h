...
class Visualizer {
 public:
  ...
  std::map<int, vtkSmartPointer <vtkActor> > VisualizeStep(int step, std::vector<int> taulist, bool show);
  std::map<int, vtkSmartPointer <vtkActor> > VisualizeStep(int step, std::vector<int> taulist);
  color bgcolor;
